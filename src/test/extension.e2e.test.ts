...
suite('scanWorkspaceDocs E2E', () => {
	test('should find documentation files in the workspace', async () => {
	...
	test('should return URIs that exist on disk', async () => {
		const docs = await scanWorkspaceDocs(vscode.workspace);
...
suite('WorkspaceWikiTreeProvider E2E', () => {
	test('should instantiate and return tree items in a real workspace', async () => {
	...
	test('should register WorkspaceWiki tree data provider', async () => {
	...
	test('should display proper icons and context values for files and folders', async () => {
		const provider = new WorkspaceWikiTreeProvider(
			vscode.workspace,
			vscode.TreeItem,
			vscode.TreeItemCollapsibleState,
	...
	test('should maintain proper folder names in hierarchical structure', async () => {
		const provider = new WorkspaceWikiTreeProvider(
			vscode.workspace,
			vscode.TreeItem,
			vscode.TreeItemCollapsibleState,
	...
	test('should handle nested directory structures correctly', async () => {
		const provider = new WorkspaceWikiTreeProvider(
			vscode.workspace,
			vscode.TreeItem,
			vscode.TreeItemCollapsibleState,
	...
	test('should provide context menu commands for file items only', async () => {
		const provider = new WorkspaceWikiTreeProvider(
			vscode.workspace,
			vscode.TreeItem,
			vscode.TreeItemCollapsibleState,
	...
	test('should respect workspaceWiki configuration settings', async () => {
	...
	test('should handle command execution for preview and edit', async () => {
	...
	test('should integrate with VS Code file opening behavior', async () => {
		const provider = new WorkspaceWikiTreeProvider(
			vscode.workspace,
			vscode.TreeItem,
			vscode.TreeItemCollapsibleState,
	...
	test('should maintain proper directory sorting across different settings', async () => {
